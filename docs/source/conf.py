...
sys.path.insert(0, os.path.abspath("../.."))
sys.path.insert(0, os.path.join(os.path.abspath("../.."), "satbucket"))
...
html_title = "sat-bucket"
html_theme_options = {
    "repository_url": "https://github.com/ghiggi/sat-bucket",
...
def run_apidoc(_):
    ...
    module_dir = os.path.join(cur_dir, "..", "..", "satbucket")
...
def linkcode_resolve(domain, info):
    ...
    fn = os.path.relpath(fn, start=os.path.dirname(satbucket.__file__))

    if "+" in satbucket.__version__:
        return f"https://github.com/ghiggi/sat-bucket/blob/main/satbucket/{fn}{linespec}"
    else:
        return f"https://github.com/ghiggi/sat-bucket/blob/" f"v{satbucket.__version__}/satbucket/{fn}{linespec}"
