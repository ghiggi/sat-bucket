...
Welcome to the sat-bucket documentation!
======================================

Here, you'll find everything you need to navigate through the data archive provided by the **Global Precipitation Measurement (Satellite)** mission.

The Satellite data archive currently includes satellite data records that extend back to 1987.
...
that forms the so-called Satellite constellation.
...
The **sat-bucket** is a Python package designed to make your life easier, whether you aim to download some data, search for specific files, or jump into scientific analysis.
...
1. **Download Satellite Products**: Quickly search and download the data you need.
...
Let's get started and unlock the full potential of the Satellite data archive together!
