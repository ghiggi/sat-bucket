...
bucket_dir = "/home/ghiggi/data/AMSR2_Bucket"
...
for ds_swath in list_ds_overpass[0:2]: 
    p = ds_swath["Tc_89V"].gpm.plot_map(add_swath_lines=False)
...
# ds_swath_remapped = ds_swath[["Tc_89V"]].gpm.remap_on(ds_aoi)    
...
da = ds_stack["Tc_89V"].ffill(dim="time").compute()
